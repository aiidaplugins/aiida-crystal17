...
OPTION_TERMS = (
    ...
    'fbond', 'fc_supercell', 'fcartesian', 'fcell', 'fenergy', 'fermi-dirac', 'ffractional', 'field', 'finite',
    'fix_atom', 'forceconstant', 'fractional', 'frequency', 'frqtol', 'ftol', 'fvectors', 'g3coulomb',
