...
@pytest.mark.parametrize(
    ...
    (
        ('cubic-rocksalt.crystal.gui', 48, 225),
        ('cubic-zincblende.crystal.gui', 24, 216),
        ('greigite.crystal.gui', 48, 227),
        ('mackinawite.crystal.gui', 16, 129),
        ('marcasite.crystal.gui', 8, 58),
        ('pyrite.crystal.gui', 24, 205),
        ('pyrrhotite-4c-monoclinic.crystal.gui', 4, 15),
        ('troilite-hex-p63mc.crystal.gui', 12, 186),
        ('troilite-hex-p63mmc.crystal.gui', 24, 194),
        ('troilite-hexagonal.crystal.gui', 12, 190),
...
def test_structure_to_symmetry(db_test_app, gui_filename,
                               num_symops, space_group):
...
def test_structure_to_symmetry_operations(
