...
@pytest.mark.parametrize('name,filepath', (
    ...
    ('cry14_opt_slab', ('crystal', 'stdout_parser', 'cry14_scf_and_opt_slab.out')),
    ...
    ('nio_opt_walltime', ('crystal', 'nio_sto3g_afm_opt_walltime', 'main.out')),
    ('nio_scf_maxcyc', ('crystal', 'nio_sto3g_afm_scf_maxcyc', 'main.out')),
    ('cry17_incomplete_scf', ('crystal', 'stdout_parser', 'cry17_incomplete_scf.out')),
    ...
    ('cry17_opt_1stcyc', ('crystal', 'stdout_parser', 'cry17_opt_converge_1stcycle.out')),
))
